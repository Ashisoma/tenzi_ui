...
/*
  HERE IS A BUG
  @action
  void changeDoubleSearchTerm(double val){
    var myVal = double.parse(searchTerm);
    // myVal = val;
    val = myVal;
    // double.parse(searchTerm) = val
  }
      ...
      for (var element in _rawTransactions) {
        ...
        if (searchTerm.isNotEmpty) {
          if (!isNumeric(searchTerm)) {
            ...
            // double _elementAmount = element.amount;
            // _elementAmount
          ...
          if (isNumeric(searchTerm)) {
            double _searchAmount = element.amount;
            double amountSearch = double.parse(searchTerm);
            if (!(_searchAmount == amountSearch)) {
              flag = false;
            }
          }

          // This is a bug and needs to be featured
          // double amountSearch = double.parse(searchTerm);
          // if(!(_elementAmount<=amountSearch)){
          //   flag = false;
          // }
        }

...
mixin _$HomeScreenStore on _HomeScreenStore, Store {
  ...
  //   final _actionInfo2 = _$_HomeScreenStoreActionController.startAction(
  //     name: '_HOmeScreenStore.changeDoubleSearchTerm');
  //   try{
  //     return super.changeDoubleSearchTerm(val);
  //   } finally{
  //     _$_HomeScreenStoreActionController.endAction(_actionInfo2);
  //   }
  // }
